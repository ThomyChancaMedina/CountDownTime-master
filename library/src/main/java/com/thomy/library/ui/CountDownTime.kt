...
class CountDownTime @JvmOverloads constructor(
    ...
    */
    ...
    fun startTimer(
        ...
        onCountDownTimeStarted: (() -> Unit)? = null,
        onCountDownTimeStopped: (() -> Unit)? = null,
        onCountDownTimeRunning: ((remainingTime: Long) -> Unit)? = null
    ) {
        this.timerCount = timerCount
        this.animationAllowed = animation
        this._onCountDownTimerStarted = onCountDownTimeStarted
        this._onCountDownTimerStopped = onCountDownTimeStopped
        this._onCountDownTimerRunning = onCountDownTimeRunning
        if (runClockwise) {
            rotateToClockWise()
        }
